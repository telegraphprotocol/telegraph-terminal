...
const QUADRANTS = [
  {
    ...
    sub: "Chatbot",
    who: "Analysts, researchers & individuals who need quick, verified answers.",
  ...
  },
  {
    ...
    sub: "Direct Access",
    who: "Software engineers, quants & developers building applications.",
  ...
  },
  {
    ...
    who: "Hedge funds, enterprises & teams running autonomous systems.",
  ...
  },
  {
    ...
    sub: "For Miners",
    who: "AI labs, subnets & companies with trained models.",
