...
export const promptScenarios: PromptScenario[] = [
  // ── 1. Personal Life (Zeus) ────────────────────────────────────────────────
  {
    ...
    terminalLogs: [
      ...
      { time: "14:32:01.721", label: "BOOKING", detail: "Searching available flights & hotels for next weekend", section: "Zeus Analysis" },
      { time: "14:32:01.856", label: "BILLING", detail: "Deducting $0.01 ×402 micro-fee", section: "Payment & Rail" },
      { time: "14:32:01.934", label: "NETWORK", detail: "Selected rail: Solana (Mainnet-Beta)", section: "Payment & Rail" },
      { time: "14:32:02.012", label: "TX",      detail: "Initiating booking settlement (id: a1b2…c3d4)", section: "Payment & Rail" },
      { time: "14:32:02.198", label: "PROOF",   detail: "Verifying zero-knowledge proof", section: "Proof Verification" },
      { time: "14:32:02.341", label: "SIGNAL",  detail: "Consensus reached — UA420 booked & paid", section: "Proof Verification" },
    ],
    receipt: {
      provider: "ZEUS",
  ...
  // ── 2. Social Media (Bitmind) ──────────────────────────────────────────────
  {
    ...
    terminalLogs: [
      ...
      { time: "14:33:01.812", label: "BILLING",  detail: "Deducting $0.01 ×402 micro-fee", section: "Payment & Rail" },
      { time: "14:33:01.934", label: "NETWORK",  detail: "Selected rail: Solana (Mainnet-Beta)", section: "Payment & Rail" },
      { time: "14:33:02.041", label: "TX",       detail: "Initiating purchase transaction (id: f8e3…9k1)", section: "Payment & Rail" },
  ...
  // ── 3. Investing (Score) ───────────────────────────────────────────────────
  {
    ...
    terminalLogs: [
      ...
      { time: "14:34:01.801", label: "CANCEL",  detail: "Kellogg's (K) buy order cancelled", section: "Payment & Rail" },
      { time: "14:34:01.912", label: "BILLING", detail: "Deducting $0.01 micro-fee", section: "Payment & Rail" },
      { time: "14:34:02.031", label: "NETWORK", detail: "Selected rail: Solana (Mainnet-Beta)", section: "Payment & Rail" },
