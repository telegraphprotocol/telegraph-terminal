      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-[64px] border-b border-border/50 flex items-center justify-between px-6 bg-background/50 backdrop-blur-xl z-20">
          <div className="flex min-w-0 flex-1 flex-wrap items-center gap-3 sm:gap-4">
            ...
            <div className="relative ml-4 min-w-0 max-w-md flex-1">
              ...
              <input 
                ...
                className="h-10 w-full rounded-lg border border-input bg-background pl-10 pr-4 text-sm text-white placeholder:text-muted-foreground transition-all focus:border-primary/50 focus:outline-none"
              />
            </div>
